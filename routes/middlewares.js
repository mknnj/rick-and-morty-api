...
const { getAll, getById, setFavouriteForId, getFavouriteForId} = require('../handlers/operations')
...
module.exports = (model) => ({
  ...
  setFavourite: [setFavouriteForId, sendRes],
  getFavourite: [getFavouriteForId, sendRes],
})
