...
const { Character, Location, Episode, Favourite } = require('./graphql/sources')
const {favourite: FavouriteModel, character: CharacterModel, location: LocationModel, episode: EpisodeModel} = require('./models/index')
...
const server = new ApolloServer({
  ...
  dataSources: () => ({
    ...
    location: new Location(LocationModel),
    episode: new Episode(EpisodeModel),
    favourite: new Favourite(FavouriteModel),
  }),
})
